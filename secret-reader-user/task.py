...
expected_arg_names.add('foo')
expected_arg_names.add('param_abc')
...
arg_type = str
foo = _parse_value(arg_value, arg_name, arg_type)
arg_name = 'param_abc'
arg_value = get_arg_value(arg_name,args,raw_args)
arg_type = str
param_abc = _parse_value(arg_value, arg_name, arg_type)
