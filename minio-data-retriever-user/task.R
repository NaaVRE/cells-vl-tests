...
expected_arg_names <- unique(c(expected_arg_names, "param_data_filename"))
expected_arg_names <- unique(c(expected_arg_names, "param_use_dummy_data"))

expected_arg_names <- unique(c(expected_arg_names, "conf_minio_public_bucket"))
expected_arg_names <- unique(c(expected_arg_names, "conf_virtual_lab_biotisan_euromarec"))
...
arg_name <- "param_data_filename"
arg_value <- get_arg_value(arg_name, opt, raw_args_list)
arg_type <- "str"
param_data_filename <- parse_value(arg_value, arg_name, arg_type)
arg_name <- "param_use_dummy_data"
arg_value <- get_arg_value(arg_name, opt, raw_args_list)
arg_type <- "int"
param_use_dummy_data <- parse_value(arg_value, arg_name, arg_type)
