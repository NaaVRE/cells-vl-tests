...
arg_parser.add_argument('--list_double_type', action='store', type=str, required=True, dest='list_double_type')

arg_parser.add_argument('--list_double_val', action='store', type=str, required=True, dest='list_double_val')
...
list_double_type = args.list_double_type.replace('"','')
list_double_val = json.loads(args.list_double_val)
